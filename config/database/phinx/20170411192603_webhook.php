...
class Webhook extends AbstractMigration
{
    /**
     * Change Method.
     *
   ...
   public  $actions = ['delete'=> 'CASCADE', 'update'=> 'CASCADE'];
    ...
    {
       $this->table('webhook', ['id' => false, 'primary_key' => ['id_webhook']])
            ->addColumn('id_webhook', 'integer', ['limit' => 11, 'null' => false, 'signed' => false,'identity'=>True])
            ->addColumn('id', 'integer', ['limit' => 11, 'null' => false, 'signed' => false])
            ->addColumn('id_str', 'string', ['limit' => 256, 'null' => false])
            ->addColumn('url', 'string', ['limit' => 2000, 'null' => false])
            ->addColumn('config', 'text', ['limit' => MysqlAdapter::TEXT_LONG, 'null' => true])
            ->addColumn('return_content', 'text', ['limit' => MysqlAdapter::TEXT_LONG, 'null' => true])
