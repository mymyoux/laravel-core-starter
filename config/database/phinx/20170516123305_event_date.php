...
class EventDate extends AbstractMigration
{
    /**
     * Change Method.
     *
   ...
   public  $actions = ['delete'=> 'CASCADE', 'update'=> 'CASCADE'];
    ...
    public function changing()
    {
        ...
        $this->table('event_action', ['id' => false, 'primary_key' => ['id_event_action']])
            ->addColumn('id_event_action', 'integer', ['limit' => 11, 'null' => false, 'signed' => false,'identity'=>True])
            ...
            ->addColumn('notification_time', 'timestamp', ['null' => true])
            ->addIndex(['id_event'])
            ->addForeignKey('id_event','event','id_event',$this->actions)
